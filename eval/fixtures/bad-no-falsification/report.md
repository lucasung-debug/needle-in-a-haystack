...
## Key sources
- https://docs.realproject.io/config#retry_backoff_ms — states the default is 2000 ms — live, retrieved 2026-06-22T14:30:00Z `[retrieved]`

## What would change the answer
A newer release note changing the default.

## Limits
Checked the stable docs only; confidence: medium.
