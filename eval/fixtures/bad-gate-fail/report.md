...
**Answer:** The default is 2000 ms. `[retrieved]`

## Key sources
- https://docs.example-project.org/config — retrieved 2026-06-22T14:30:00Z `[retrieved]`
...
[FALSIFY]: Leading candidate survived an explicit disconfirmation attempt   [FAIL]
