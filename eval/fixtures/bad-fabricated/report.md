...
**Answer:** The default is 2000 ms, per the official configuration reference. `[retrieved]`

## Key sources
- https://example.com/made-up-page — "the default is 2000 ms" — retrieved 2026-06-22T14:30:00Z `[retrieved]`
